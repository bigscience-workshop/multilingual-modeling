...
# Specify a job name:
#SBATCH -J exp-024-pilot_baseline_sft

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_sft.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_sft.err
...
model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-350m_${language}_sft_1000samples_-1vocab_original-frozen"
