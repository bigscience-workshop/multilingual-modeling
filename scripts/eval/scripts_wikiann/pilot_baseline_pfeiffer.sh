...
# Specify a job name:
#SBATCH -J exp-024-pilot_baseline_pfeiffer

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_pfeiffer.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_pfeiffer.err
