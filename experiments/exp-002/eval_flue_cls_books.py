...
# split: books
cls_train_dataset = cls_train_dataset.filter(lambda x:x['category']=="books")
cls_val_dataset = cls_val_dataset.filter(lambda x:x['category']=="books")
cls_test_dataset = cls_test_dataset.filter(lambda x:x['category']=="books")
