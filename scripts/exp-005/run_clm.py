...
def main():
    ...
    with training_args.main_process_first(desc="dataset map tokenization"):
        saved_tokenized_datasets_fp = pathlib.Path(f"{training_args.output_dir}/tokenized_datasets.pt")
        ...
        if saved_tokenized_datasets_fp.exists() and saved_tokenized_datasets_fp.is_file():
            ...
            print("Sanity check: loaded tokenized_datasets")
        else:
            ...
            print("Sanity check: saved tokenized_datasets")
    ...
    with training_args.main_process_first(desc="grouping texts together"):
        saved_lm_datasets_fp = pathlib.Path(f"{training_args.output_dir}/lm_datasets.pt")
        saved_lm_datasets_fp.parent.mkdir(parents=True, exist_ok=True)
        if saved_lm_datasets_fp.exists() and saved_lm_datasets_fp.is_file():
            lm_datasets = torch.load(str(saved_lm_datasets_fp))
            print("Sanity check: loaded lm_datasets")
        else:
            ...
            print("Sanity check: saved lm_datasets")
