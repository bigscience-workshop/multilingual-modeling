...
# Specify a job name:
#SBATCH -J exp-021-wikiann-baseline_wikiann_de

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-021-wikiann/baseline_wikiann_de.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-021-wikiann/baseline_wikiann_de.err
...
OUTPUT_DIR="/users/zyong2/data/zyong2/bigscience/data/processed/021-wikiann/bloom-1b3-baseline-de" # where you want to save checkpoints at
LANG="de"
