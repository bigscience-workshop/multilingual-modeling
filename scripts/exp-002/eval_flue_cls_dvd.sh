...
# Specify a job name:
#SBATCH -J exp-002-eval_flue_cls_dvd

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/002/eval_flue_cls_dvd.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/002/eval_flue_cls_dvd.err
...
for lr in ${learning_rates[@]} ; do
    echo "LR ===== $lr"
    # change dvd
    OUTPUT_DIR="$FP_BIGS/data/processed/exp-002/flue-cls-dvd-gpt2-tok/$lr"
