...
# Specify a job name:
#SBATCH -J exp-024-pilot_baseline_continued_pretraining

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_continued_pretraining.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_continued_pretraining.err
...
# model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-350m_${language}_continual-pretrain-reinit_100000samples_-1vocab_original/"
