...
# Specify a job name:
#SBATCH -J exp-025-xling-pilot_xling_sft

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_sft.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_sft.err
...
model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-350m_${language}_sft_100000samples_-1vocab_original-frozen/"
