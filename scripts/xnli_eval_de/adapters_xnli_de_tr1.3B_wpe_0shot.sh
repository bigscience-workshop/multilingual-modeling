...
# Specify a job name:
#SBATCH -J exp-013-adapters_xnli_de_tr1.3B_wpe_0shot

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-013/adapters_xnli_de_tr1.3B_wpe_0shot.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-013/adapters_xnli_de_tr1.3B_wpe_0shot.err
