...
# Specify a job name:
#SBATCH -J exp-024-tatoeba-pilot_bitfit

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024-tatoeba/pilot_bitfit.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024-tatoeba/pilot_bitfit.err
...
language="az-en"
model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-350m_az_bitfit_100000samples_-1vocab_original-frozen"
