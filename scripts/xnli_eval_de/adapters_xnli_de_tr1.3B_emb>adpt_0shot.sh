...
# Specify a job name:
#SBATCH -J exp-013-adapters_xnli_detr1.3B_emb>adpt_0shot

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-013/adapters_xnli_de_tr1.3B_emb>adpt_0shot.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-013/adapters_xnli_de_tr1.3B_emb>adpt_0shot.err
...
for lr in ${learning_rates[@]} ; do
    ...
    LANG="de"
    OUTPUT_DIR="$FP_BIGS/data/processed/013/xnli_de_50K>50K_adpt_0shot"
