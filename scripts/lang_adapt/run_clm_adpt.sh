...
output_dir="/users/zyong2/data/zyong2/bigscience/data/processed/020/${LANG}_adpt_${MAX_TRAIN_SAMPLES}samples"
logging_dir="/users/zyong2/data/zyong2/bigscience/data/reports/020/${LANG}_adpt_${MAX_TRAIN_SAMPLES}samples"
mkdir -p $output_dir
mkdir -p $logging_dir
