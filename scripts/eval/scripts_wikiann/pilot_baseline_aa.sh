...
# Specify a job name:
#SBATCH -J exp-024-pilot_baseline_aa

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_aa.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024/pilot_baseline_aa.err
...
model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-350m_${language}_aa_100000samples_-1vocab_original-frozen/"
