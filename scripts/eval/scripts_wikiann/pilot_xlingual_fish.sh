...
# Specify a job name:
#SBATCH -J exp-025-xling-pilot_xling_fish

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_fish.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_fish.err
...
model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-350m_${language}_fish_100000samples_-1vocab_original-frozen/"
