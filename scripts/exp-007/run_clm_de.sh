...
# Specify a job name:
#SBATCH -J exp-007-run_clm_de_madx

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/007/run_clm_de_madx.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/007/run_clm_de_madx.err
...
output_dir="${FP_BIGS}/data/processed/exp-007/madx-gpt2-de"
logging_dir="${FP_BIGS}/reports/exp-007/madx-gpt2-de"
