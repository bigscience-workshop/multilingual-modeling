...
# Specify a job name:
#SBATCH -J exp-024-run_clm_bitfit_az_350m

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024/run_clm_bitfit_az_350m_%a.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024/run_clm_bitfit_az_350m_%a.err
