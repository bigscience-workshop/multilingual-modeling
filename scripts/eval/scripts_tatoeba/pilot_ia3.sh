...
# Specify a job name:
#SBATCH -J exp-024-tatoeba-pilot_ia3

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024-tatoeba/pilot_ia3.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024-tatoeba/pilot_ia3.err
...
language="az-en"
model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-350m_az_ia3_100000samples_-1vocab_original-frozen"
