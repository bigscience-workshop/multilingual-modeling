...
# Specify a job name:
#SBATCH -J exp-024-tatoeba-pilot_baseline_original

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-024-tatoeba/pilot_baseline_original.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-024-tatoeba/pilot_baseline_original.err
