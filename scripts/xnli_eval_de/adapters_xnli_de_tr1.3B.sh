...
# Specify a job name:
#SBATCH -J exp-013-adapters_xnli_de_tr1.3B

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-013/adapters_xnli_de_tr1.3B_%a.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-013/adapters_xnli_de_tr1.3B_%a.err
