...
# Specify a job name:
#SBATCH -J exp-025-xling-pilot_xling_original

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_original.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_original.err
