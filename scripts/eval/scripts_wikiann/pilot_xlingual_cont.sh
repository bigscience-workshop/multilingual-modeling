...
# Specify a job name:
#SBATCH -J exp-025-xling-pilot_xling_cont

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_cont.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/log-025-xling/pilot_xling_cont.err
...
model_name="/users/zyong2/data/zyong2/bigscience/data/processed/024/bloom-560m_az_continual-pretrain-reinit_100000samples_-1vocab_original"
