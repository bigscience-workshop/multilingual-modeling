...
# Specify a job name:
#SBATCH -J exp-004-eval_paws_fr_swapped_embedding_no_ft

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/004/eval_paws_fr_swapped_embedding_no_ft.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/004/eval_paws_fr_swapped_embedding_no_ft.err
