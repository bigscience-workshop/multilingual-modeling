...
# Specify a job name:
#SBATCH -J exp-002-eval_flue_paws

# Specify an output file
#SBATCH -o /users/zyong2/data/zyong2/bigscience/logs/002/eval_flue_paws.out
#SBATCH -e /users/zyong2/data/zyong2/bigscience/logs/002/eval_flue_paws.err
